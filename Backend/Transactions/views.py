...
class TransactionList (generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs): #Modificar el método create para que actualice el stock del libro
...
class TransactionDetail (generics.RetrieveUpdateAPIView):
    ...
    def update(self, *args, **kwargs): #Modificar el metodo update para que actualice el stock y la fecha de devolución
